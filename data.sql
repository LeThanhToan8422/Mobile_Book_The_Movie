...
-- Dumping data for table databasecinema.accounts: ~5 rows (approximately)
INSERT INTO `accounts` (`id`, `accountID`, `email`, `password`, `userID`) VALUES
	(1, 'AC8', 'min@gmail.com', 'Min28062812', 'US1'),
	(2, 'AC9', 'chieu@gmail.com', 'minchieu280684', 'US8'),
	(3, 'AC13', 'toan@gmail.com', '123456789', 'US9'),
	(4, 'AC14', 'tran@gmail.com', '123456', 'US13'),
	(5, 'AC15', 'thanhtoan@gmail.com', '123456789', 'US14');
...
INSERT INTO `moviedates` (`id`, `movieDateID`, `date`, `cinemaID`, `movieID`) VALUES
	(1, 'MD1', '2024-12-28 00:00:00', 'CNM6', 'MV1'),
	(2, 'MD2', '2024-12-28 00:00:00', 'CNM1', 'MV1'),
	(3, 'MD3', '2024-12-28 00:00:00', 'CNM6', 'MV2'),
	(4, 'MD4', '2024-12-28 00:00:00', 'CNM1', 'MV2'),
	(5, 'MD5', '2024-12-28 00:00:00', 'CNM6', 'MV3'),
	(6, 'MD6', '2024-12-28 00:00:00', 'CNM1', 'MV3'),
	(7, 'MD7', '2024-12-28 00:00:00', 'CNM6', 'MV4'),
	(8, 'MD8', '2024-12-28 00:00:00', 'CNM1', 'MV4'),
	(9, 'MD9', '2024-12-28 00:00:00', 'CNM6', 'MV5'),
	(10, 'MD10', '2024-12-28 00:00:00', 'CNM1', 'MV5'),
	(12, 'MD11', '2024-12-28 00:00:00', 'CNM6', 'MV6'),
	(13, 'MD13', '2024-12-28 00:00:00', 'CNM1', 'MV6');
...
-- Dumping data for table databasecinema.movies: ~12 rows (approximately)
...
-- Dumping data for table databasecinema.showtimes: ~37 rows (approximately)
...
-- Dumping data for table databasecinema.tickets: ~29 rows (approximately)
INSERT INTO `tickets` (`id`, `ticketID`, `quantityTickets`, `seats`, `combos`, `totalPrices`, `userID`, `movieID`, `cinemaID`, `movieDateID`, `showTimeID`) VALUES
	...
	(17, 'TK17', 2, 'J3;J4', 'OL Special Combo1 Bap nam XX loc xoay (Sweet);OL Special Combo1 Khoai Lac (Sweet)', 450000, 'US1', 'MV5', 'CNM6', 'MD9', 'ST27'),
	(18, 'TK18', 2, 'J3;J4', 'OL Special Combo1 Bap nam XX loc xoay (Sweet);OL Special Combo1 Khoai Lac (Sweet)', 410000, 'US1', 'MV1', 'CNM6', 'MD1', 'ST1'),
	(19, 'TK19', 1, 'A1', 'OL Special Combo1 Bap nam XX loc xoay (Sweet);OL Special Combo1 Khoai Lac (Sweet)', 375000, 'US1', 'MV5', 'CNM6', 'MD9', 'ST25'),
	(20, 'TK20', 1, 'J1', 'OL Special Combo1 Bap nam XX loc xoay (Sweet)', 225000, 'US9', 'MV5', 'CNM1', 'MD10', 'ST31'),
	(21, 'TK21', 2, 'J2;J3', 'OL Special Combo1 Bap nam XX loc xoay (Sweet)', 300000, 'US13', 'MV5', 'CNM1', 'MD10', 'ST31'),
	(22, 'TK22', 1, 'J1', 'OL Special Combo1 Bap nam XX loc xoay (Sweet)', 210000, 'US9', 'MV1', 'CNM6', 'MD1', 'ST3'),
	(23, 'TK23', 1, 'J1', 'OL Special Combo1 Bap nam XX loc xoay (Sweet)', 225000, 'US9', 'MV6', 'CNM6', 'MD11', 'ST33'),
	(24, 'TK24', 1, 'J1', 'OL Special Combo1 Khoai Lac (Sweet)', 225000, 'US9', 'MV5', 'CNM6', 'MD9', 'ST26'),
	(25, 'TK25', 2, 'J3;J4', 'OL Special Combo1 Bap nam XX loc xoay (Sweet)', 300000, 'US9', 'MV6', 'CNM6', 'MD11', 'ST33'),
	(26, 'TK26', 1, 'J4', 'OL Special Combo1 Khoai Lac (Sweet)', 210000, 'US9', 'MV1', 'CNM6', 'MD1', 'ST2'),
	(27, 'TK27', 1, 'J2', 'OL Special Combo1 Khoai Lac (Sweet)', 225000, 'US9', 'MV5', 'CNM6', 'MD9', 'ST26'),
	(28, 'TK28', 1, 'J1', 'OL Special Combo1 Bap nam XX loc xoay (Sweet);OL Special Combo1 Khoai Lac (Sweet)', 375000, 'US14', 'MV6', 'CNM6', 'MD11', 'ST32'),
	(29, 'TK29', 1, 'J3', 'OL Special Combo1 Bap nam XX loc xoay (Sweet)', 225000, 'US14', 'MV5', 'CNM6', 'MD9', 'ST25'),
	(30, 'TK30', 2, 'J1;J2', 'OL Special Combo1 Bap nam XX loc xoay (Sweet)', 300000, 'US14', 'MV4', 'CNM6', 'MD7', 'ST19'),
	(31, 'TK31', 2, 'J2;J3', 'OL Special Combo1 Khoai Lac (Sweet)', 300000, 'US13', 'MV6', 'CNM6', 'MD11', 'ST33'),
	(32, 'TK32', 2, 'A3;A4', 'OL Special Combo1 Bap nam XX loc xoay (Sweet)', 290000, 'US14', 'MV1', 'CNM6', 'MD1', 'ST1'),
	(33, 'TK33', 1, 'A1', 'OL Special Combo1 Khoai Lac (Sweet)', 225000, 'US14', 'MV3', 'CNM6', 'MD5', 'ST13'),
	(34, 'TK34', 2, 'A3;A4', 'OL Special Combo1 Bap nam XX loc xoay (Sweet)', 300000, 'US14', 'MV5', 'CNM6', 'MD9', 'ST26'),
	(35, 'TK35', 1, 'H5', 'OL Special Combo1 Bap nam XX loc xoay (Sweet)', 225000, 'US14', 'MV6', 'CNM6', 'MD11', 'ST34'),
	(36, 'TK36', 2, 'J3;J4', 'OL Special Combo1 Bap nam XX loc xoay (Sweet)', 300000, 'US14', 'MV1', 'CNM6', 'MD1', 'ST3'),
	(37, 'TK37', 2, 'J4;J3', 'OL Special Combo1 Bap nam XX loc xoay (Sweet)', 300000, 'US14', 'MV6', 'CNM1', 'MD11', 'ST37'),
	(38, 'TK38', 2, 'J3;J4', 'OL Special Combo1 Bap nam XX loc xoay (Sweet)', 300000, 'US14', 'MV1', 'CNM6', 'MD1', 'ST3'),
	(39, 'TK39', 2, 'J4;J3', 'OL Special Combo1 Khoai Lac (Sweet)', 300000, 'US1', 'MV3', 'CNM6', 'MD5', 'ST14'),
	(40, 'TK40', 1, 'J3', 'OL Special Combo1 Bap nam XX loc xoay (Sweet)', 225000, 'US1', 'MV5', 'CNM6', 'MD9', 'ST25');
...
-- Dumping data for table databasecinema.users: ~4 rows (approximately)
INSERT INTO `users` (`id`, `userID`, `email`, `name`, `phone`, `dateOfBirth`, `gender`) VALUES
	...
	(8, 'US8', 'chieu@gmail.com', 'Thanh Toan', '0329623380', '2002-04-08 00:00:00', 0),
	(12, 'US9', 'toan@gmail.com', 'Thanh Toan', '0329623388', '2002-04-08 00:00:00', 1),
	(13, 'US13', 'tran@gmail.com', 'Quyen Tran', '0329658932', '2023-11-15 00:00:00', 0),
	(14, 'US14', 'thanhtoan@gmail.com', 'Le Thanh Toan', '0329623387', '2002-04-08 00:00:00', 0);
